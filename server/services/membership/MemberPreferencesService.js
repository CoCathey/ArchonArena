...
/**
 * ARCHON (N12): reads and writes which previews a member has switched on.
 *
 ...
 * honoured is decided at read time by previews.js against live capabilities, so
 * a lapsed membership stops applying without this table being touched.
 *
 * It once carried cosmetic slots too. Those moved to ProfileCosmetics when the
 * two parallel cosmetics implementations were folded into one - see
 * server/services/membership/cosmetics.js.
 */
