            ...
            <div className='min-h-full w-full'>
                <Panel title={t('About Archon Arena - Help and information')}>
                    ...
                    <Trans i18nKey='about.whatisthis'>
                        ...
                        <p>
                            Archon Arena is a competitive platform for playing KeyForge, the Unique
                            Deck Game from Ghost Galaxy, in your browser. Beyond casual games it
                            adds the things a competitive scene needs: an Elo-style rating that
                            accounts for deck power (SAS) and margin of victory,
                            worldwide/regional/country/state leaderboards, tournaments for online
                            and in-person play, clubs, and friends.
                        </p>
                    </Trans>
                    <Trans i18nKey='about.gettingstarted'>
                        ...
                        <p>
                            ...
                            <Link href='/decks'>Decks page</Link> — import your whole collection at
                            once with your Decks of KeyForge username, or paste a single Master
                            Vault link. Then jump into a game from{' '}
                    ...
                    <Trans i18nKey='about.ratings'>
                        ...
                        <p>
                            ...
                            deck&apos;s SAS score adjusts the expected result (upsetting a stronger
                            deck pays more than stomping with one), and the key differential of the
                            final score scales the exchange (a 3-0 moves more points than a 3-2).
                            New players are provisional for their first games while the system finds
                            their level.
                        </p>
                    </Trans>
                    <Trans i18nKey='about.whydiscarded'>
                        ...
                        <p>
                            ...
                            Fisher-Yates algorithm - true randomness - which can feel harsher than
                            the imperfect human shuffling you are used to at a table. The randomness
                            has been verified over millions of test draws. If you believe you have
                            found a genuine card bug, please report it on GitHub.
                        </p>
                    </Trans>
                    <Trans i18nKey='about.thanks'>
                        ...
                        <p>
                            ...
                            project - the engine behind The Crucible Online - which itself descends
                            from the ringteki and jinteki family of card game platforms. Our sincere
                            thanks to all of their maintainers and contributors: this platform
                    ...
                    <Trans i18nKey='about.colors'>
                        ...
                        <ul className='list-disc pl-6'>
                            <li>
                                <span className='username role-admin'>admin</span> - site
                                administrator
                            </li>
                            <li>
                                <span className='username role-contributor'>contributor</span> -
                                people who have made significant development contributions to the
                                site
                            </li>
                            <li>
                                <span className='username role-supporter'>supporter</span> -
                                financial supporters of the platform
                            </li>
                            <li>
                    ...
                    <Trans i18nKey='about.addnotes'>
                        ...
                        <p>
                            ...
                            with this site in any way. Archon Arena exists so passionate fans can
                            play the game they love and, we hope, buy more of it.
                        </p>
                    </Trans>
                </Panel>
            </div>
