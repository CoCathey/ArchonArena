...
// ARCHON: brand mark generated by scripts/generate-brand-assets.js
...
const Navigation = (props) => {
    ...
    // In a game the navbar is crowded, so collapse to the mark alone
    const showWordmark = !currentGame?.started;
            ...
            <div className='mx-auto flex h-full w-full items-center px-2 sm:px-3 lg:px-4'>
                <div className='flex w-full items-center justify-between lg:hidden'>
                    ...
                    <Link href='/' className='inline-flex h-full items-center'>
                        <img src={BrandMark} className='h-8 w-8' alt={props.appName} />
                    </Link>
                    <HeroButton
                ...
                <div className='hidden h-full w-full items-center gap-2 lg:flex'>
                    ...
                    <Link href='/' className='inline-flex h-full items-center gap-2 px-2'>
                        <img src={BrandMark} className='h-8 w-8' alt={props.appName} />
                        {showWordmark && (
                            <span
                                className={`whitespace-nowrap text-lg font-bold uppercase tracking-[0.2em] ${
                                    isLightTheme ? 'text-black' : 'text-foreground'
                                }`}
                            >
                                {props.appName}
                            </span>
