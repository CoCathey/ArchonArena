...
server/services/championschallenge/SimulatedGame.js  the lab's driver, now delegating to BotPolicy
...
Champion’s Challenge SimulatedGame into `BotPolicy`, and both the lab and the
